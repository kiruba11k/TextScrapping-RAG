...
# Conditional edge: If retrieval is successful, proceed to response generation; otherwise, use LLM
def retrieval_condition(output):
    return bool(output)  # If retrieval gives results, return True

workflow.add_edge("scraper", "retriever")
workflow.add_conditional_edges("retriever", retrieval_condition, {"True": None, "False": "llm_fallback"})
